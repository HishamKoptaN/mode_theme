...
TextTheme _baseTextTheme({required TextStyle baseTextStyle}) {
  return TextTheme(
...
TextTheme getDarkTextTheme({
  required ColorScheme colorScheme,
  required TextStyle baseTextStyle,
}) => _baseTextTheme(baseTextStyle: baseTextStyle).apply(
  bodyColor: colorScheme.onSurface.withAlpha((0.8 * 255).round()),
